			...
			if (args.length > 1) {
				...
				case "find":
					...
					case "stronghold":
						...
						break;
					case "end_city":
						found = getIfDimension(new MapGenEndCity(new ChunkProviderEnd(worldIn, true, worldIn.getSeed(), pos)).getNearestStructurePos(worldIn, pos, findUnexplored), worldIn, 1);
						break;
					case "scattered":
					...
					case "fortress":
						...
						break;
					case "mansion":
						found = getIfDimension(new WoodlandMansion(new ChunkProviderOverworld(worldIn, worldIn.getSeed(), true, "")).getNearestStructurePos(worldIn, pos, findUnexplored), worldIn, 0);
						break;
					}
