...
public class save {
	...
	public static class Commandsave extends com.ptsmods.morecommands.miscellaneous.CommandBase {
		...
		public void execute(MinecraftServer server, ICommandSender sender, String[] args) {
			...
			Reference.sendServerMessage(server, "The worlds have been saved, time taken: " + (System.currentTimeMillis() - start) + " ms.");
		}
		...
		public Permission getPermission() {
			return new Permission(Reference.MOD_ID, "save", "Save all worlds on the (internal) server.", true);
		}
