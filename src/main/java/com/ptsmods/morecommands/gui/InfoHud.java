		...
		if (mc.player != null && mc.world != null)
			try {
				switch (key) {
					...
					case "gamemode": {output = Objects.requireNonNull(mc.interactionManager).getCurrentGameMode().name(); break;}
					...
					case "lookingAtSide": {output = result.getType() == HitResult.Type.BLOCK ? Objects.requireNonNull(bResult).getSide().getName() : "none"; break;}
