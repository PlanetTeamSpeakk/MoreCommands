...
public class ClientOptions {
	...
	public static class Rendering {
		...
		@Comment({"Whether fog should be rendered.", "Goes for all types of fog so includes blindness."})
		public static final ClientOption<Boolean> renderFog = new ClientOption<>(true);
	}
