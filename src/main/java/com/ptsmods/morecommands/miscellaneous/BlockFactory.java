...
public class BlockFactory<T extends Block> {
	...
	public T getBlock() throws AbstractBlockException, ReflectiveOperationException {
		try {
			return (T) blockClass.newInstance().setTranslationKey(unlocalizedName).setRegistryName(location);
	 ...
	 * consumes any exceptions thrown.
	 * If an exception occurs, its stacktrace is printed and {@code null} is
	 * returned.
	 *
