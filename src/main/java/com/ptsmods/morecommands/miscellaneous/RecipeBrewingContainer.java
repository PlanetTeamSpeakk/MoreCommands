...
public class RecipeBrewingContainer extends Container {
	...
	public RecipeBrewingContainer(List<ItemStack> stacks, InventoryPlayer playerInventory) {
		reagentInventory.setInventorySlotContents(0, stacks.get(1));
		...
		inputInventories[1].setInventorySlotContents(0, stacks.get(0));
		inputInventories[2].setInventorySlotContents(0, ItemStack.EMPTY);
		outputInventory.setInventorySlotContents(0, stacks.get(2));
