...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/ptsmods/morecommands/miscellaneous/CopySound", null, map("net/minecraft/class_1101", "net/minecraft/client/sound/MovingSoundInstance", "net/minecraft/client/resources/sounds/AbstractTickableSoundInstance"), null);

classWriter.visitSource("CopySound.java", null);
...
methodVisitor.visitLdcInsn("morecommands:copy");
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/ptsmods/morecommands/miscellaneous/CopySound", "volume", "F");
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitLineNumber(17, label2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "com/ptsmods/morecommands/miscellaneous/CopySound", "repeat", "Z");
Label label3 = new Label();
methodVisitor.visitLabel(label3);
methodVisitor.visitLineNumber(18, label3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/ptsmods/morecommands/miscellaneous/CopySound", "tick", "()V", false);
...
methodVisitor.visitLocalVariable("this", "Lcom/ptsmods/morecommands/miscellaneous/CopySound;", null, label0, label5, 0);
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitLocalVariable("this", "Lcom/ptsmods/morecommands/miscellaneous/CopySound;", null, label0, label1, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/ptsmods/morecommands/miscellaneous/CopySound", "x", "D");
Label label2 = new Label();
methodVisitor.visitLabel(label2);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/ptsmods/morecommands/miscellaneous/CopySound", "y", "D");
Label label3 = new Label();
methodVisitor.visitLabel(label3);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/ptsmods/morecommands/miscellaneous/CopySound", "z", "D");
Label label4 = new Label();
methodVisitor.visitLabel(label4);
