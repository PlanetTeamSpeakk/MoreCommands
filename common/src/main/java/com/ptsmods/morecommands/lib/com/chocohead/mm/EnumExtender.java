package com.ptsmods.morecommands.lib.com.chocohead.mm;
		...
		return node -> {
			...
			for (EnumAdder.EnumAddition addition : builder.getAdditions()) {
				...
				if (builder.hasParameters()) {
					...
					fieldSetting.add(new FieldInsnNode(Opcodes.GETSTATIC, "com/ptsmods/morecommands/lib/com/chocohead/mm/EnumExtender", "POOL", "Ljava/util/Map;"));
