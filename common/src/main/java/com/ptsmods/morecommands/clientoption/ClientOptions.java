...
public class ClientOptions {
    public static class Rendering {
        ...
        public static final BooleanClientOption bigTabPager = Platform.isFabric() ? new BooleanClientOption(RENDERING, "Big Tag Pager", false,
                "Whether you want the pager in the creative menu", "to be larger than normal.", "This does offset the buttons from their usual position.") : null;
