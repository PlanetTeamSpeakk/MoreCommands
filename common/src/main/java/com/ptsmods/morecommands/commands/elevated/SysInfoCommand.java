...
public class SysInfoCommand extends Command {
    ...
    public void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(literalReqOp("sysinfo")
                .executes(ctx -> sendSysInfo(ctx, s -> sendMsg(ctx, s))));
    }
    ...
    public static int sendSysInfo(CommandContext<CommandSourceStack> ctx, Consumer<String> sender) {
