                ...
                .executes(ctx -> {
                    ...
                    while (true) {
                        for (int x1 = 0; x1 < 64; x1++) { // it will look 64 blocks in front of you at most.
                            ...
                            if ((!MoreCommands.blockBlacklist.contains(block) || entity instanceof Player &&
                                    ((MixinPlayerEntityAccessor) entity).getAbilities_().flying) && MoreCommands.blockWhitelist.contains(tpblock) &&
                                    MoreCommands.blockWhitelist.contains(tpblock2)) {
