...
public class MixinWorldRenderer {
    ...
    @Shadow
    private static void renderShape(PoseStack matrixStack, VertexConsumer vertexConsumer, VoxelShape voxelShape, double d, double e, double f, float g, float h, float i, float j) {}
}
